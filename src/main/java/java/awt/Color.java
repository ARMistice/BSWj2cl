...
public class Color {
    ...
    public Color makeColor(float r, float g, float b, float a) {
        Color ret=new Color((int)(r*255+0.5), (int)(g*255+0.5), (int)(b*255+0.5), (int)(a*255+0.5));
        ret.frgbvalue = new float[3];
        ret.frgbvalue[0] = r;
        ret.frgbvalue[1] = g;
        ret.frgbvalue[2] = b;
        ret.falpha = a;
        ret.fvalue = frgbvalue;
        return ret;
    }
     ...
     *                    with the same {@code alpha} value.
     * @see        bsw.awt.Color#brighter
     * @since      JDK1.0
     */
    public Color darker() {
    	//return new Color(0xffeedd);
    ...
    public String toString() {
    	return "rgba("+getRed()+","+getGreen()+","+getBlue()+","+((double)getAlpha()/255.0D)+")";
